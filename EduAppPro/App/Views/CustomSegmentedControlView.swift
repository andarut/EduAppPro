...
@IBDesignable class CustomSegmentedControl: UIControl {
    ...
    override func layoutSubviews() {
        ...
        let selectedImage = UIImageView(frame: selectFrame)
        selectedImage.image = UIImage(named: "SegmentedBackgroundSelected")
        thumbView.frame = selectFrame
        thumbView.addSubview(selectedImage)
        thumbView.backgroundColor = thumbColor
        thumbView.layer.cornerRadius = thumbView.frame.height / 3
