...
class CustomClassesCell: UIView {
    ...
    func configure(with model: CustomClassesCellModel) {
        ...
        if model.haveClasswork {
            ...
            if model.textClip == true {
                ...
                mainLabel.frame = CGRect(x: 44.5, y: self.mainLabel.frame.minY, width: 343.4, height: 56)
                line.frame = CGRect(x: self.line.frame.minX, y: self.line.frame.minY + self.line.frame.height + self.mainLabel.frame.height - 20, width: self.line.frame.width, height: self.line.frame.height)
            }
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        classesPageController.input = "Занятия"
