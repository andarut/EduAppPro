...
extension ClassesController: VAMonthHeaderViewDelegate {
...
extension ClassesController: VAMonthViewAppearanceDelegate {
...
extension ClassesController: VADayViewAppearanceDelegate {
    ...
    func textBackgroundColor(for state: VADayState) -> UIColor {
        switch state {
        case .selected:
            return UIColor.UIColorFromRGB(rgbValue: 0x27AE60)
        default:
            return .clear
        }
    }
...
extension ClassesController: VACalendarViewDelegate {
...
extension ChatController: MSGDataSource {
...
extension ChatController: MSGDelegate {
